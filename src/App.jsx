...
export default function App() {
...

  {
    ...
    description:
      "An API-driven advice generator with dynamic UI updates.",
  ...
  const experience = [
    {
      ...
      summary: "Resolve complex sender and account issues while documenting bugs and collaborating with engineering teams"
    },
      {
        role: "Identity Support Specialist",
      company: "Rippling",
      date: "Apr 2024 - Sept 2024",
      summary: "Supported identity verification and authentication issues within a high-volume SaaS environment."
    },
    {
      role: "Order Fulfillment QA",
      company: "Amplify",
      date: "Oct 2022 - Nov 2023",
      summary: "Reviewed and validated sales order documentation while collaborating with cross-functional teams to ensure accuracy and prevent fulfillment issues."
    },
    {
      role: "Technical Specialist",
      company: "Apple",
      date: "Nov 2019 - May 2021",
      summary: "Provided advanced troubleshooting and technical support for Apple devices while delivering customer-focused solutions."
    },
  ];
...
<div className="mx-auto max-w-6xl px-6">
  ...
  Hi, I’m Breia John — building clean, responsive frontend applications.
</h1>
</div>
{/* description */}
  <p className="mt-6 max-w-2xl text-lg leading-8 text-slate-300">
    I’m a frontend developer and technical support professional with a strong eye for
    usability, detail, and responsive design.
  </p>
  <p className="mt-4 max-w-2xl text-base text-slate-400">
  Focused on React, JavaScript, responsive UI, and user-centered problem solving.
</p>
{/* buttons */}
...
<section id="featured-projects" className="py-24">
  <div className="mb-8">
    ...
    <p className="mt-3 max-w-2xl text-slate-300">
      Projects that best represent my frontend development skills and experience
...
<div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
  {featuredProjects.map((project) => (
    <div
      key={project.title}
      className="rounded-3xl border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:bg-white/[0.07] hover:shadow-2xl"
     >

      {/* Project Image */}
    <div className="relative mb-4 h-48 w-full overflow-hidden rounded-xl border border-white/10 bg-slate-900">
  <img
    src={project.image}
    alt={project.title}
      ...
      <div className="mt-6 flex gap-3">
        ...
        <section id="early-projects" className="py-24">
          <div className="mb-8">
            ...
            <p className="mt-3 max-w-2xl text-slate-300">
  Earlier and challenge-based projects that show my learning process,
  practice, and progression as a developer.
</p>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
            {growthProjects.map((project) => (
              <div
  key={project.title}
  className="rounded-3xl border border-white/10 bg-white/5 p-6 transition duration-300 hover:-translate-y-1 hover:bg-white/[0.07] hover:shadow-xl"
>
  ...
  <h3 className="text-xl font-semibold">{project.title}</h3>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="mt-6 inline-block rounded-xl border border-white/20 px-4 py-2 font-medium text-white"
                >
                  View Project
                </a>
              </div>
...
<section className="py-24">
  ...
  <p>Frontend
React · JavaScript · HTML · CSS · Responsive Design</p>

  <div className="mt-10 grid gap-10 lg:grid-cols-[0.9fr_1.1fr]">
    <div>
      <h3 className="text-2xl font-semibold">Skills</h3>
      <p className="mt-4 max-w-xl text-slate-300">
        I combine frontend development learning with real-world technical support experience, which helps me build with both usability and problem-solving in mind.
      </p>
    ...
    <div>
      ...
      <p>Technical Support
Troubleshooting · Authentication Workflows · Technical Support</p>
...
<footer className="mt-24 border-t border-white/10 py-12">
  <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
    <div>
      ...
      <h2 className="mt-2 text-3xl font-bold text-white">Let’s Connect</h2>
      <p className="mt-4 max-w-xl text-slate-300">
        I’m actively building my frontend portfolio and open to junior frontend,
        technical support, and entry-level software opportunities.
      </p>
    </div>
